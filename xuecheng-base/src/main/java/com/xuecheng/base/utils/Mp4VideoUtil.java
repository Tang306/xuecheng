...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        ...
        String ffmpeg_path = "E:\\FFmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "D:\\Java\\project\\xuechengzaixian\\bigfiles\\cloud01.avi";
        //转换后mp4文件的名称
        String mp4_name = "cloud01.mp4";
        //转换后mp4文件的路径
        String mp4_path = "D:\\Java\\project\\xuechengzaixian\\bigfiles\\cloud01.mp4";
        //创建工具类对象
